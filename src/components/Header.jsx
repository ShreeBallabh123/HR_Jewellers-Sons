            ...
            <div className="relative z-50">
              ...
              {showNotifications && (
                <>
                  ...
                  <div className="absolute left-0 mt-2.5 w-80 sm:w-96 bg-white dark:bg-zinc-955 border border-solid border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.12)] dark:shadow-[0_15px_40px_rgba(0,0,0,0.3)] z-50 overflow-hidden text-zinc-800 dark:text-zinc-200">
