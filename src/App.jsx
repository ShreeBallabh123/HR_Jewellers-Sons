    ...
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none">
      <defs>
        <linearGradient id="goldGradNav" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="30%" stopColor="#DDA0DD" />
          <stop offset="70%" stopColor="#BA55D3" />
          <stop offset="100%" stopColor="#4A126D" />
        </linearGradient>
      </defs>
      <circle cx="50" cy="50" r="44" fill="none" stroke="url(#goldGradNav)" strokeWidth="1.5" strokeDasharray="2,2" />
      <circle cx="50" cy="50" r="40" fill="none" stroke="url(#goldGradNav)" strokeWidth="2.5" />
      <circle cx="50" cy="50" r="36" fill="none" stroke="url(#goldGradNav)" strokeWidth="0.75" opacity="0.6" />
      <path d="M50,16 L53,23 L50,21 L47,23 Z" fill="url(#goldGradNav)" />
      <circle cx="50" cy="13" r="1.5" fill="url(#goldGradNav)" />
      
      {/* Monogram initials H and R intertwined */}
      <path d="M37,34 L37,66 M37,50 L47,50 M47,34 L47,66" stroke="url(#goldGradNav)" strokeWidth="4" strokeLinecap="round" fill="none" />
      <path d="M33,34 L41,34 M33,66 L41,66 M43,34 L51,34" stroke="url(#goldGradNav)" strokeWidth="2" strokeLinecap="round" />
      <path d="M47,34 L57,34 C63,34 65,38 65,43 C65,48 61,50 55,50 L47,50 M55,50 L63,66" stroke="url(#goldGradNav)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <path d="M51,66 L67,66" stroke="url(#goldGradNav)" strokeWidth="2" strokeLinecap="round" />
      
      <path d="M50,77 L52,80 L55,80 L53,82 L54,85 L50,83 L46,85 L47,82 L45,80 L48,80 Z" fill="url(#goldGradNav)" />
    </svg>
  );
}
...
export default function App() {
  ...
  const getInitialPage = () => {
    try {
      ...
      const validPages = ['admin', 'savings', 'gold-coins', 'heritage', 'valuation', 'collections', 'showrooms', 'terms-and-conditions', 'product-detail'];
      ...
      <main className="animate-fade-in">
            ...
            <div className={`pb-0 transition-colors duration-500 ${isCatalogDark ? "text-[#FCFAFF]" : "text-[#4A126D]"}`}>
                    ...
                    <div id="shop-by-category" className="w-full pt-0 pb-16 lg:pb-20 px-6 sm:px-12 select-none" style={{ background: '#fdfaf8' }}>
                      <section className="max-w-[1836px] mx-auto">
                        ...
                        <motion.div
                          ...
                          className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-x-[28px] gap-y-[34px] justify-center mx-auto pt-6"
                        >
                          {homeCategories.map((cat, idx) => {
                            ...
                            return (
                              <motion.div
                                ...
                                onClick={handleClick}
                                className="w-full max-w-[205px] h-[210px] sm:h-[250px] lg:h-[285px] bg-white border border-[rgba(0,0,0,0.04)] rounded-[28px] shadow-[0_8px_24px_rgba(0,0,0,0.04)] flex flex-col items-center justify-between relative overflow-hidden hover:-translate-y-[3px] transition-all duration-[250ms] ease group cursor-pointer"
                                style={{
                                  paddingTop: '30px',
                                  paddingLeft: '20px',
                                  paddingRight: '20px',
                              ...
                              >
                                ...
                                <div className="w-full h-[100px] sm:h-[120px] lg:h-[145px] flex items-center justify-center relative bg-transparent">
                                  <img
                                    src={cat.img}
                                    alt={cat.name}
                                ...
                                {/* Category Title Below Image inside the card */}
                                <span 
                                  className="text-center font-sans tracking-tight line-clamp-2 mt-auto text-[11px] sm:text-[12px] lg:text-[13px]"
                                  style={{
                                    fontFamily: 'inherit',
                                    fontWeight: '600',
                                    lineHeight: '1.35',
                ...
                <div className="w-full px-4 md:px-12 space-y-10 relative group/sect">
                  ...
                  >
                    ...
                    <button 
                      ...
                      className={`absolute left-2 md:left-4 z-10 p-2.5 rounded-full border shadow-lg transition-all duration-300 -translate-x-4 opacity-0 group-hover/sect:opacity-100 group-hover/sect:translate-x-0 cursor-pointer hidden md:flex items-center justify-center ${
                        isCatalogDark 
                      ...
                      {recommendedCategories.map((cat, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div 
                              className={`w-[90px] h-[90px] sm:w-[110px] sm:h-[110px] rounded-full overflow-hidden border flex items-center justify-center transition-transform duration-300 ease group-hover:scale-105 ${
                                isCatalogDark 
                            ...
                            {/* Category Name below */}
                            <span 
                              className={`font-sans text-[11px] sm:text-xs tracking-wider uppercase font-semibold transition-colors duration-300 ${
                                isCatalogDark ? 'text-gray-300 group-hover:text-[#DDA0DD]' : 'text-[#3d2619] group-hover:text-[#DDA0DD]'
                              }`}
                            >
                              {cat.name}
                            </span>
                    ...
                    <button 
                      ...
                      className={`absolute right-2 md:right-4 z-10 p-2.5 rounded-full border shadow-lg transition-all duration-300 translate-x-4 opacity-0 group-hover/sect:opacity-100 group-hover/sect:-translate-x-0 cursor-pointer hidden md:flex items-center justify-center ${
                        isCatalogDark 
                          ? 'bg-[#252525]/90 backdrop-blur-sm border-[#DDA0DD]/20 text-[#DDA0DD] hover:bg-[#333]' 
                          : 'bg-white/95 backdrop-blur-sm border-[#DDA0DD]/25 text-[#DDA0DD] hover:bg-gray-50'
                      }`}
                      ...
                      >
                        ...
                        >
                          ...
                          <div 
                            ...
                            className={`w-[285px] shadow-[0_15px_35px_rgba(0,0,0,0.06),0_5px_15px_rgba(0,0,0,0.02)] rounded-xs pt-5 px-5 pb-8 relative flex flex-col items-center select-none snap-center transition-all duration-300 hover:scale-[1.04] hover:rotate-0 hover:z-40 cursor-pointer border mt-[20px] overflow-visible ${
                              isCatalogDark 
                          ...
                          >
                            ...
                            <div className="w-full space-y-2 text-left px-1">
                              ...
                              <p className={`font-sans text-[10px] sm:text-[11px] leading-relaxed tracking-wide font-normal ${
                                isCatalogDark ? "text-[#e5c2c6]" : "text-[#8C6D70]"
                              }`}>
                                {item.quote}
                              </p>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-6 mt-6">
                  ...
                  <div className="flex justify-center mt-12">
                    <button
                      ...
                      className={`px-8 py-3 rounded-none text-xs font-semibold tracking-[0.2em] uppercase transition-all duration-300 border cursor-pointer ${
                        isCatalogDark
              ...
              {(() => {
                const timelineItems = [
                  ...
                  { yr: 2026, title: "BlueStone accredited Atelier Partnership", desc: "Transitioning to a fully accredited BlueStone partner boutique, integrating advanced live gold API conversion matrices, digital certification catalogs, and instant WhatsApp booking." }
                ];
                      ...
                      <div className="relative flex justify-between items-center w-full px-[12px]">
                        {timelineItems.map((item) => {
                          ...
                          return (
                            ...
                            >
                              {/* Dot Selector */}
                              <div className={`w-6 h-6 rounded-full border-2 transition-all duration-300 flex items-center justify-center font-bold text-[9px] ${
                                isActive 
                              ...
                              {/* Year Text */}
                              <span className={`text-[13px] font-bold font-sans tracking-wider mt-3 transition-colors duration-300 ${
                                isActive ? 'text-[#DDA0DD]' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-200'
                              }`}>
                                {item.yr}
                              </span>
                            </div>
                      ...
                      <div className="flex-1 max-w-2xl mx-auto text-center min-h-[140px] flex flex-col items-center justify-center px-4 overflow-hidden">
                        <AnimatePresence mode="wait">
                          ...
                          >
                            ...
                            <p className={`text-xs sm:text-sm font-light leading-relaxed font-sans max-w-2xl mx-auto transition-colors duration-500 ${
                              isCatalogDark ? 'text-gray-400' : 'text-[#1B1B1B]/75'
                            }`}>
                              {activeItem.desc}
                            </p>
                          </motion.div>
              ...
              <section className="max-w-3xl mx-auto px-6 py-4 space-y-8">
                <div className="text-center space-y-3">
                  <span className="text-[10px] uppercase tracking-[0.35em] text-[#DDA0DD] font-bold font-sans">ATELIER ASSISTANCE</span>
        ...
        {currentPage === 'savings' && (
          <div className={`transition-colors duration-500 min-h-screen pb-8 ${isCatalogDark ? 'bg-[#1C1C1C] text-[#FBF9FF]' : 'bg-[#FAF7F2] text-[#1B1B1B]'}`}>
            ...
            <div className="flex justify-center select-none">
              <div className="backdrop-blur-md p-1.5 rounded-full border border-gray-200/80 shadow-[0_8px_32px_0_rgba(15,23,42,0.06)] inline-flex items-center space-x-1 bg-white/70">
                <button 
                  ...
                  className={`px-6 py-2.5 rounded-full text-xs uppercase tracking-widest font-black transition-all duration-300 flex items-center gap-1.5 cursor-pointer ${
            ...
            <div className={`border rounded-[3rem] p-6 md:p-12 shadow-2xl relative overflow-hidden animate-fade-in text-xs select-none transition-colors duration-500 ${
              isCatalogDark 
            ...
            <div className={`rounded-[2.5rem] border p-8 md:p-16 space-y-12 shadow-sm animate-fade-in text-xs relative select-none transition-colors duration-500 ${
              isCatalogDark 
              ...
              <div className="hidden lg:grid grid-cols-12 gap-12 items-center pt-4 relative z-10">
                ...
                <div className="col-span-6 flex justify-center relative">
                  <div className="w-[520px] h-[520px] relative flex items-center justify-center">
                    ...
                    <button
                      ...
                      className={`absolute w-12 h-12 rounded-full border-2 flex items-center justify-center font-bold text-sm tracking-wider shadow-lg transition-all duration-500 cursor-pointer z-20 ${
                        activeStoryStep === 0
                    ...
                    <div className={`absolute w-[320px] h-[320px] rounded-full border backdrop-blur-md flex flex-col items-center justify-center text-center p-8 shadow-inner z-10 transition-all duration-500 ${
                      isCatalogDark 
                ...
                <div className="col-span-6 space-y-6 relative flex flex-col justify-center min-h-[520px]">
                  ...
                  <div
                    ...
                    onClick={() => { triggerAudio('click'); setActiveStoryStep(0); }}
                    className={`backdrop-blur-md border rounded-3xl p-6 shadow-sm hover:shadow-[0_12px_36px_rgba(212,175,55,0.08)] hover:-translate-y-1 transition-all duration-500 cursor-pointer flex items-start gap-5 group z-10 relative ${
                      activeStoryStep === 0
                  ...
                  >
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-bold transition-all duration-500 shrink-0 ${
                      activeStoryStep === 0
        ...
        {currentPage === 'collections' && (
          <div className={`transition-colors duration-500 min-h-screen pb-20 pt-8 ${isCatalogDark ? 'bg-[#F4ECF9] text-[#4A126D]' : 'bg-[#FCFAFF] text-[#4A126D]'}`}>
            <div className="max-w-7xl mx-auto px-6 space-y-12 animate-slide-up">
              ...
              <div className={`relative overflow-hidden rounded-[2.5rem] border p-8 sm:p-16 text-center select-none backdrop-blur-xl transition-all duration-500 ${
                isCatalogDark 
                ...
                <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 blur-[100px] rounded-full pointer-events-none z-0 transition-colors ${
                  isCatalogDark ? 'bg-[#DDA0DD]/15' : 'bg-[#DDA0DD]/10'
                }`}></div>
                
                {/* Minimal dotted matrix overlay */}
                <div className={`absolute inset-0 opacity-10 [background-size:16px_16px] pointer-events-none z-0 ${
                  isCatalogDark 
                ...
                <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                  ...
                  <div className="relative inline-block pt-2">
                    ...
                    <h1 className={`relative serif-luxury text-4xl sm:text-7xl font-bold tracking-wide leading-tight transition-colors duration-550 ${
                      isCatalogDark ? 'text-[#4A126D]' : 'text-[#4A126D]'
                    }`}>
                      All Jewellery
                    </h1>
                    {/* Gold accent line */}
                  ...
                  {/* Sub text */}
                  <p className={`text-xs sm:text-sm tracking-widest font-light normal-case max-w-lg mx-auto leading-relaxed transition-colors ${
                    isCatalogDark ? 'text-[#4A126D]/80' : 'text-[#4A126D]/85'
                  }`}>
                  ...
                  {PREMIUM_CATEGORIES.map((cat) => {
                    ...
                    return (
                      <button
                        ...
                        className={`snap-center shrink-0 w-[250px] lg:w-full h-[180px] sm:h-[210px] lg:h-[230px] p-4 flex flex-col justify-between items-center text-center cursor-pointer transition-all duration-300 ease group ${
                          isActive
                      ...
                      >
                        ...
                        <div className="space-y-1 w-full flex flex-col items-center mt-auto">
                          ...
                          <span className={`text-[10px] uppercase font-bold tracking-widest flex items-center gap-1 transition-colors duration-300 ${
                            isActive ? 'text-[#DDA0DD]' : 'text-[#666666] group-hover:text-[#DDA0DD]'
                          }`}>
                    ...
                    <div className="flex gap-2">
                      {['all', 'gold', 'silver'].map(metal => (
                        <button
                          ...
                          className={`flex-1 py-2 rounded-xl text-[9px] uppercase font-bold tracking-widest transition-all duration-300 border text-center cursor-pointer ${
                            metalFilter === metal 
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {['all', '18K', '22K', '24K'].map(purity => (
                        <button
                          ...
                          className={`py-2 rounded-xl text-[9px] uppercase font-bold tracking-widest transition-all duration-300 border text-center cursor-pointer ${
                            purityFilter === purity 
                              ? 'bg-[#4A126D] text-white border-[#4A126D] shadow-sm scale-[1.02]'
                              : 'bg-[#FCFAFF] text-gray-700 border-gray-200 hover:border-gold hover:bg-white hover:text-[#4A126D]'
                          }`}
                      ...
                      {['Collections', 'Rings', 'Earrings', 'Necklace', 'Mangalsutra', 'Bracelets', 'Bangles', 'Gold Coins', 'Anklets', 'Men Jewellery', 'Kids Jewellery', 'Gifts & Pooja'].map(cat => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-xl text-[8px] uppercase tracking-widest font-extrabold transition-all duration-300 border cursor-pointer ${
                              isActive 
                                ...
                                >
                                  <svg
                                    className={`w-3.5 h-3.5 transition-colors duration-300 ${
                                      isWishlisted ? 'text-[#DDA0DD] fill-current scale-110' : 'text-gray-400 fill-none'
                                    }`}
                                    stroke="currentColor"
                                    strokeWidth="2"
                                    viewBox="0 0 24 24"
                        ...
                        {Array.from({ length: totalPages }).map((_, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-9 h-9 rounded-xl text-xs font-bold transition-all duration-300 border cursor-pointer flex items-center justify-center ${
                                isActive
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                ...
                <div className="lg:col-span-6 space-y-8">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`relative rounded-2xl overflow-hidden aspect-square flex items-center justify-center p-2 transition-all duration-500 cursor-pointer focus:outline-none hover:-translate-y-1 ${
                            isActive 
                  ...
                  <div className="glass-luxury-dark rounded-[2rem] p-7 space-y-5 border border-[#DDA0DD]/30 shadow-[0_15px_45px_rgba(0,0,0,0.4)] relative overflow-hidden transition-all duration-500 hover:border-[#DDA0DD]/50 hover:shadow-[0_20px_50px_rgba(212,175,55,0.15)]">
                    ...
                    {zipCheckResult && (
                      <div className={`p-4 rounded-xl text-[11px] font-semibold transition-all border leading-relaxed font-sans ${
                        zipCheckResult.status === 'success' 
                ...
                <div className="lg:col-span-6 space-y-8">
                            ...
                            {['22K Yellow Gold', '18K Rose Gold', 'PT 950 Platinum'].map((metal) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`py-3 px-3 text-[10px] font-bold rounded-xl border uppercase tracking-wider text-left transition-all flex items-center justify-between cursor-pointer focus:outline-none ${
                                    isActive 
                                ...
                                >
                                  ...
                                  <span className={`w-2.5 h-2.5 rounded-full border flex items-center justify-center transition-all ${
                                    isActive ? 'border-[#DDA0DD] bg-[#DDA0DD]' : 'border-white/30'
                                  }`}>
                  ...
                  <div className="glass-luxury-dark rounded-[2rem] p-6 space-y-3.5 border border-[#DDA0DD]/30 shadow-[0_15px_40px_rgba(0,0,0,0.4)] transition-all duration-500 hover:border-[#DDA0DD]/45 group">
                    ...
                    <div className={`overflow-hidden transition-all duration-500 ease-in-out text-[11px] text-white/75 leading-relaxed space-y-3 text-justify border-t border-white/10 pt-3.5 font-sans ${
                      pdpTcExpanded ? 'max-h-[300px] opacity-100 mt-2' : 'max-h-0 opacity-0'
                    }`}>
                  ...
                  <div className="flex flex-col gap-4 pt-2">
                    ...
                    <div className="grid grid-cols-4 gap-3.5 items-stretch">
                      ...
                      <button
                        onClick={() => { triggerAudio('click'); setPdpTcExpanded(!pdpTcExpanded); }}
                        className={`col-span-1 border-2 rounded-full font-extrabold text-[10px] uppercase tracking-wider transition-all duration-300 flex items-center justify-center cursor-pointer focus:outline-none shadow-md ${
                          pdpTcExpanded 
                ...
                <div className="flex justify-center border-b border-white/10 max-w-lg mx-auto gap-4 md:gap-8">
                  {[
                    ...
                    <button
                      ...
                      className={`pb-3 text-[10px] uppercase font-bold tracking-widest text-center cursor-pointer transition-all focus:outline-none border-b-2 ${
                        pdpActiveTab === item.tabId 
                          ...
                          {allReviews.map((_, idx) => (
                            <button
                              ...
                              className={`h-1.5 rounded-full transition-all duration-500 cursor-pointer focus:outline-none ${
                                idx === (pdpActiveReviewIdx % allReviews.length) 
                                  ? 'w-6 bg-[#DDA0DD]' 
        ...
        {currentPage === 'heritage' && (
          <div className={`transition-colors duration-500 min-h-screen pb-8 ${
            isCatalogDark 
                  ...
                  <div className="relative pt-6 w-full max-w-md sm:max-w-xl mx-auto lg:mx-0 px-2">
                    ...
                    <div className="relative z-10 flex justify-between items-center text-center w-full">
                      {[1952, 1974, 1998, 2014, 2026].map((yr) => (
                        ...
                        >
                          <span className={`text-[10px] sm:text-xs tracking-wider font-extrabold transition-all duration-300 ${
                            activeStoryTimeline === yr ? 'text-[#DDA0DD] scale-110' : 'opacity-50 hover:opacity-100'
                          }`}>
                            {yr}
                          </span>
                          <span className={`w-8 h-8 rounded-full border-2 transition-all duration-300 flex items-center justify-center font-bold text-[9px] ${
                            activeStoryTimeline === yr 
                          ...
                          <span className={`text-[7px] uppercase tracking-wider font-extrabold transition-all duration-300 block ${
                            activeStoryTimeline === yr ? 'opacity-100 text-[#DDA0DD]' : 'opacity-0 sm:opacity-40 sm:group-hover:opacity-75'
                          }`}>
                      ...
                      <div className="bg-white border border-[#DDA0DD]/20 rounded-[24px] p-6 space-y-5 text-left shadow-sm">
                        ...
                        <div className="flex rounded-full p-1 border border-[#DDA0DD]/20 bg-[#4B136A]/5">
                          <button 
                            ...
                            className={`flex-1 text-center font-bold text-[10px] uppercase tracking-wider py-2.5 rounded-full transition-all duration-300 focus:outline-none cursor-pointer ${
                              selectedMetal === 'gold' 
                          ...
                          {selectedMetal === 'gold' ? (
                            [
                              ...
                              <button
                                ...
                                className={`w-full p-3 rounded-[16px] border text-left flex justify-between items-center transition-all duration-300 cursor-pointer focus:outline-none ${
                              ...
                              >
                                ...
                                <span className={`w-4 h-4 rounded-full border-2 flex items-center justify-center text-[9px] font-black ${
                                  selectedPurity === pur.id ? 'border-[#DDA0DD] text-[#DDA0DD]' : 'border-gray-300 text-transparent'
                                }`}>
                                  ✓
                                </span>
                              </button>
                ...
                <div className="flex items-center space-x-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`px-4 py-2 text-[10px] uppercase font-bold tracking-wider rounded-lg border transition-all duration-305 cursor-pointer whitespace-nowrap ${
                        coinPurityTab === tab.key
                ...
                <div className="flex items-center space-x-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-[10px] font-bold rounded-lg border transition-all duration-305 cursor-pointer ${
                        coinWeightFilter === filter.key
                          ? 'bg-gold border-gold text-[#4A126D] shadow-md'
                          : isCatalogDark
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {filteredCoins.map((coin) => {
                      ...
                      return (
                        <div 
                          key={coin.id}
                          className={`group border rounded-3xl p-6 transition-all duration-500 flex flex-col relative overflow-hidden select-none hover:-translate-y-1.5 gold-glow-border ${
                            isCatalogDark 
                        ...
                        >
                          ...
                          <div className={`relative aspect-square rounded-2xl flex items-center justify-center p-6 mb-5 overflow-hidden transition-colors ${isCatalogDark ? 'bg-[#4A126D]/40' : 'bg-[#FBF9FF]'}`}>
                            ...
                            <button
                              ...
                              className={`absolute top-3 right-3 p-2.5 rounded-full border transition-all duration-305 cursor-pointer ${
                                isWishlisted
                          ...
                          <div className="mt-5 grid grid-cols-2 gap-2 pt-3 border-t" style={{ borderColor: isCatalogDark ? '#FFFFFF05' : '#FBF9FF' }}>
                            <button
                              ...
                              className={`py-2 text-[8px] uppercase tracking-widest font-black rounded-lg border transition-all cursor-pointer ${
                                isCatalogDark
              ...
              <div className="max-w-7xl mx-auto px-6 sm:px-8 text-center space-y-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                  {[
                    ...
                    <div 
                      key={idx}
                      className={`group border rounded-3xl p-6 text-left space-y-4 hover:-translate-y-2 hover:z-10 gold-glow-border transition-all duration-500 relative overflow-hidden ${
                        isCatalogDark 
                          ? 'glass-luxury-dark border-gold/15 hover:border-[#DDA0DD]/50 shadow-lg hover:shadow-[0_15px_40px_rgba(212,175,55,0.15)]' 
                          : 'glass-luxury-light border-gold/10 hover:border-[#DDA0DD]/45 shadow-md hover:shadow-[0_15px_40px_rgba(212,175,55,0.08)]'
                      }`}
              ...
              <div className="max-w-7xl mx-auto px-6 sm:px-8 text-center space-y-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    ...
                    <div 
                      key={idx}
                      className={`group border rounded-3xl p-6 text-left space-y-4 hover:-translate-y-1.5 transition-all duration-500 hover:shadow-lg relative overflow-hidden ${
                        isCatalogDark 
                  ...
                  <nav className="space-y-1">
                    {TERMS_DATA.map((sec) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 rounded-xl text-[11px] transition-all duration-300 flex items-center justify-between group ${
                  ...
                  {TERMS_DATA.map((sec) => {
                    ...
                    return (
                      <section
                        key={sec.id}
                        id={sec.id}
                        className={`bg-white border rounded-3xl p-6 sm:p-8 shadow-sm transition-all duration-500 ${
                          isActive 
      ...
      <footer className="bg-[#12071B] text-white border-t border-[#E6C687]/20 pt-16 pb-10 px-6 md:px-12 relative z-10 font-sans">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.2fr_auto_0.8fr_auto_1fr_auto_1.1fr] gap-x-8 gap-y-12 items-start text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
            <div className="relative group">
              ...
              <LogoCrest className="relative w-20 h-20 filter drop-shadow-[0_2px_15px_rgba(230,198,135,0.4)]" />
            </div>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row justify-between items-center text-white/50 text-[10px] tracking-widest uppercase font-sans font-medium gap-6 lg:gap-0">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 text-white/60">
            <button 
              onClick={() => { triggerAudio('click'); setPolicyModalContent('Privacy Policy'); }} 
            ...
            <button 
              onClick={() => { triggerAudio('click'); setPolicyModalContent('Terms & Conditions'); }} 
              className="hover:text-white transition-colors cursor-pointer focus:outline-none"
            >
              Terms &amp; Conditions
            </button>
            ...
            <button 
              ...
              className="hover:text-[#E6C687] flex items-center gap-1.5 transition-colors duration-300 focus:outline-none cursor-pointer"
            >
              ...
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center space-x-1.5">
                  ...
                  <span className={`text-[9px] uppercase tracking-wider font-bold ${
                    customDesignStep === step ? 'text-[#4A126D]' : 'text-gray-400'
                  }`}>
              ...
              <form onSubmit={handleCustomDesignSubmit} className="space-y-4">
                ...
                {customDesignStep === 3 && (
                  <div className="space-y-4 animate-fade-in">
                    ...
                    <div className={`border-2 border-dashed rounded-2xl p-6 text-center space-y-2 transition-colors relative ${
